...
function AboutMe() {
    return (
        <div className="aboutAll">
            ...
            <p>I have a full clean driving licence and am happy to travel in the UK and internationally if required. I hold a UK passport as well as an EU residence permit and (hopefully) soon Hungarian citizenship allowing work in the EU if required. I can speak and read a bit of Hungarian. I can read Russian.</p>
